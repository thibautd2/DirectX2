...
bool FoliageShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, Matrix viewMatrix,
...
bool FoliageShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, Matrix viewMatrix,
	Matrix projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
