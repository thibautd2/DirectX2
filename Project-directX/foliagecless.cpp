...
bool FoliageClass::Frame(Vector3 cameraPosition, ID3D11DeviceContext* deviceContext)
{
	Matrix rotateMatrix, translationMatrix, rotateMatrix2, finalMatrix;
...
bool FoliageClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices[1].position = Vector3(0.0f, 1.0f, 0.0f);  // Top left.
	vertices[1].texture = Vector2(0.0f, 0.0f);

	vertices[2].position = Vector3(1.0f, 0.0f, 0.0f);  // Bottom right.
	vertices[2].texture = Vector2(1.0f, 1.0f);

	vertices[3].position = Vector3(1.0f, 0.0f, 0.0f);  // Bottom right.
	vertices[3].texture = Vector2(1.0f, 1.0f);

	vertices[4].position = Vector3(0.0f, 1.0f, 0.0f);  // Top left.
	vertices[4].texture = Vector2(0.0f, 0.0f);

	vertices[5].position = Vector3(1.0f, 1.0f, 0.0f);  // Top right.
	...
	for (i = 0; i<m_instanceCount; i++)
	{
		...
		m_Instances[i].color = Vector3(m_foliageArray[i].r, m_foliageArray[i].g, m_foliageArray[i].b);
	}
