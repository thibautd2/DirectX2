...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, int, int, Matrix, Matrix, ID3D11ShaderResourceView*);
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext*, Matrix, Matrix, ID3D11ShaderResourceView*);
