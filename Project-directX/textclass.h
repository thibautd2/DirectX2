...
public:
	...
	void Shutdown();
	void Render(ID3D11DeviceContext*, ShaderManagerClass*, Matrix, Matrix, Matrix, ID3D11ShaderResourceView*);
...
private:
	...
	void RenderSentence(ID3D11DeviceContext*, ShaderManagerClass*, Matrix, Matrix, Matrix, ID3D11ShaderResourceView*);
