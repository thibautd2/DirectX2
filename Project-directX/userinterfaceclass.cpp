...
bool UserInterfaceClass::Initialize(D3DClass* Direct3D, int screenWidth, int screenHeight)
{
	...
	result = m_PositionStrings[0].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "X: 0",  10, 90,  1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_PositionStrings[1].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "Y: 0",  10, 110,  1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_PositionStrings[2].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "Z: 0",  10, 130,  1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_PositionStrings[3].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "rX: 0", 10, 170, 1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_PositionStrings[4].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "rY: 0", 10, 190, 1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_PositionStrings[5].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 16, "rZ: 0", 10, 210, 1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	...
	// Initialize the position text strings.
	result = m_VideoStrings[0].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 256, videoString,  10, 10,  1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
	result = m_VideoStrings[1].Initialize(Direct3D->GetDevice(), m_Font1, screenWidth, screenHeight, 64, videoMemory,  10, 30,  1.0f, 1.0f, 1.0f, false, Direct3D->GetDeviceContext());  if(!result) { return false; }
...
void UserInterfaceClass::Render(D3DClass* Direct3D, ShaderManagerClass* ShaderManager, Matrix worldMatrix, Matrix viewMatrix, Matrix orthoMatrix)
{
	int i;
...
bool UserInterfaceClass::UpdatePositionStrings(float posX, float posY, float posZ, float rotX, float rotY, float rotZ, ID3D11DeviceContext* deviceContext)
{
	...
	if(positionX != m_previousPosition[0])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[0].UpdateSentence(m_Font1, finalString, 10, 90, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
	...
	if(positionY != m_previousPosition[1])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[1].UpdateSentence(m_Font1, finalString, 10, 110, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
	...
	if(positionZ != m_previousPosition[2])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[2].UpdateSentence(m_Font1, finalString, 10, 130, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
	...
	if(rotationX != m_previousPosition[3])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[3].UpdateSentence(m_Font1, finalString, 10, 170, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
	...
	if(rotationY != m_previousPosition[4])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[4].UpdateSentence(m_Font1, finalString, 10, 190, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
	...
	if(rotationZ != m_previousPosition[5])
	{
		...
		strcat_s(finalString, tempString);
		result = m_PositionStrings[5].UpdateSentence(m_Font1, finalString, 10, 210, 1.0f, 1.0f, 1.0f, deviceContext); if(!result) { return false; }
	}
