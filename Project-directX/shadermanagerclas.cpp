...
void ShaderManagerClass::RenderTextureShader(ID3D11DeviceContext* deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ID3D11ShaderResourceView* texture)
{
...
void ShaderManagerClass::RenderFoliageShader(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, Matrix viewMatrix, Matrix projectionMatrix, ID3D11ShaderResourceView* texture)
{
